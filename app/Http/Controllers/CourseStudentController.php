...
class CourseStudentController extends Controller
{
    ...
    public function index($course_id)
    {
        ...
        return $this->createErrorResponse("The course with the given id does not exists", 404);
    }
    ...
    public function store($course_id, $student_id)
    {
        ...
        if($course)
        {
            ...
            return $this->createErrorResponse("The student with the id {$student_id} does not exists.", 404);
        }
